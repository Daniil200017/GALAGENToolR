...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](01):[/cyan] [bold yellow]Накрутить деньги                 500[/red]")
            console.print("[bold][cyan](02):[/cyan] [bold yellow]Накрутить коины                 1500[/red]")
            console.print("[bold][cyan](03):[/cyan] [bold yellow]Сделать ранг кинг                400[/red]")
            console.print("[bold][cyan](04):[/cyan] [bold yellow]Сделать кастом айди              600[/red]")
            console.print("[bold][cyan](05):[/cyan] [bold yellow]Изменить имя                     100[/red]")
            console.print("[bold][cyan](06):[/cyan] [bold yellow]Изменить имя (На радужное)       100[/red]")
            console.print("[bold][cyan](07):[/cyan] [bold yellow]Установить номера                500[/red]")
            console.print("[bold][cyan](08):[/cyan] [bold yellow]Удалить аккаунт                 FREE[/red]")
            console.print("[bold][cyan](09):[/cyan] [bold yellow]Зарегистрировать аккаунт        FREE[/red]")
            console.print("[bold][cyan](10):[/cyan] [bold yellow]Удалить всех друзей              300[/red]")
            console.print("[bold][cyan](11):[/cyan] [bold yellow]Разблокировать платные авто     1700[/red]")
            console.print("[bold][cyan](12):[/cyan] [bold yellow]Разблокировать все авто         1400[/red]")
            console.print("[bold][cyan](13):[/cyan] [bold yellow]Разблокировать мигалки на всех авто 2000[/red]")
            console.print("[bold][cyan](14):[/cyan] [bold yellow]Разблокировать двигатель w16     800[/red]")
            console.print("[bold][cyan](15):[/cyan] [bold yellow]Разблокировать все гудки         700[/red]")
            console.print("[bold][cyan](16):[/cyan] [bold yellow]Отключить получение урона        700[/red]")
            console.print("[bold][cyan](17):[/cyan] [bold yellow]Разблокировать безлимитное топливо 1500[/red]")
            console.print("[bold][cyan](18):[/cyan] [bold yellow]Разблокировать дом 3            2500[/red]")
            console.print("[bold][cyan](19):[/cyan] [bold yellow]Разблокировать дым              2000[/red]")
            console.print("[bold][cyan](20):[/cyan] [bold yellow]Изменить победы в гонках        800[/red]")
            console.print("[bold][cyan](21):[/cyan] [bold yellow]Изменить поражения в гонках     800[/red]")
            console.print("[bold][cyan](22):[/cyan] [bold yellow]Клонировать аккаунт             4000[/red]")
